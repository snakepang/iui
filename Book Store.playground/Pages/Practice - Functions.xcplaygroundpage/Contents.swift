...
func distinctAuthors() -> [String] {
    ...
    authorname = Array(Set(authorname)).sorted()
...
func getBook(at index: Int) -> (title: String, author: String, price: Double)? {
   var bookindex = books[index]
    if index <= books.count{
        return (title: bookindex["title"]!,author : bookindex["author"]!,price:Double(bookindex["price"]!)!)
    }
    else{
        return nil
    }
